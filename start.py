...
config_content = f'''// Configuration for IDS-ML v2.0
// Local development uses localhost:{BACKEND_PORT}, Production uses Render.com
...
print(f"   🔧 config.js → Environment-aware API_BASE (Local: {BACKEND_PORT})")
